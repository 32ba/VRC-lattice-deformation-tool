...
namespace Net._32Ba.LatticeDeformationTool.Editor
{
    internal static class LocKey
    {
        ...
        internal const string ClipboardEmpty = "net.32ba.lattice-deformation-tool.localization.clipboard-empty";
        internal const string ClipboardInvalidSource = "net.32ba.lattice-deformation-tool.localization.clipboard-invalid-source";
        internal const string ClipboardInvalidTarget = "net.32ba.lattice-deformation-tool.localization.clipboard-invalid-target";
        internal const string ClipboardInvalidLayer = "net.32ba.lattice-deformation-tool.localization.clipboard-invalid-layer";
        internal const string ClipboardInvalidGroup = "net.32ba.lattice-deformation-tool.localization.clipboard-invalid-group";
        internal const string ClipboardInvalidPayload = "net.32ba.lattice-deformation-tool.localization.clipboard-invalid-payload";
        internal const string ClipboardNonFinitePayload = "net.32ba.lattice-deformation-tool.localization.clipboard-nonfinite-payload";
        internal const string ClipboardUnreadableMesh = "net.32ba.lattice-deformation-tool.localization.clipboard-unreadable-mesh";
        internal const string ClipboardProfileReadOnly = "net.32ba.lattice-deformation-tool.localization.clipboard-profile-read-only";
        internal const string ClipboardVertexCountMismatch = "net.32ba.lattice-deformation-tool.localization.clipboard-vertex-count-mismatch";
        internal const string ClipboardTopologyMismatch = "net.32ba.lattice-deformation-tool.localization.clipboard-topology-mismatch";
        internal const string ClipboardGroupIncompatible = "net.32ba.lattice-deformation-tool.localization.clipboard-group-incompatible";
        internal const string ClipboardRejectedFormat = "net.32ba.lattice-deformation-tool.localization.clipboard-rejected-format";
        internal const string EditUnavailableComponent = "net.32ba.lattice-deformation-tool.localization.edit-unavailable-component";
        internal const string EditUnavailableGroup = "net.32ba.lattice-deformation-tool.localization.edit-unavailable-group";
        internal const string EditUnavailableLayer = "net.32ba.lattice-deformation-tool.localization.edit-unavailable-layer";
        internal const string EditUnavailableWeight = "net.32ba.lattice-deformation-tool.localization.edit-unavailable-weight";
        internal const string EditBlendShapeOutputInfo = "net.32ba.lattice-deformation-tool.localization.edit-blendshape-output-info";
