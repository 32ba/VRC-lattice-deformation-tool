...
namespace Net._32Ba.LatticeDeformationTool
{
    ...
    public class LatticeDeformer : MonoBehaviour
    {
        ...
        {
            get => Mathf.Max(0f, _clearanceWarningDistance);
            set => _clearanceWarningDistance = Mathf.Max(0f, value);
        }

        public float ClearanceTargetDistance
        {
            get => Mathf.Max(ClearanceWarningDistance, _clearanceTargetDistance);
            set => _clearanceTargetDistance = Mathf.Max(ClearanceWarningDistance, value);
        }
